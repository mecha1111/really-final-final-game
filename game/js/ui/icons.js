...
const ICONS = {
  ...
  // 게임 시작 오프닝 도우미 말풍선의 "팁 있음" 표시(ui/gameOpening.js, 2026-09-08
  // 전에는 ui/intro.js였다) — 캐릭터 위에서 깜빡이는 노란 전구. 참조 문서
  // (.xp-assist .bulb)와 같은 모티프지만 여기 규격(24×24, currentColor 단색)으로
  // 다시 그렸다 — 색은 쓰는 쪽 CSS가 정한다.
  bulb: `
