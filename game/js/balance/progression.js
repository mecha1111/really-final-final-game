...
export const PROGRESSION = {
  baseQuota: 200,
  // ★ 2026-08-22 완화: 1.2 → 1.15. 1구간(250MB/180초)은 판정이 좋았는데 2·3구간이
  //   급하게 뛰었다(250→300→360). 1.15면 250→288→331로 계단이 눕는다.
  //   콤보(systems/combo.js)가 구간당 +40~60MB쯤 보태주는 걸 전제로 잡은 값이라,
  //   콤보를 못 쓰면 2·3구간이 빡세고 잘 쓰면 할 만한 = 실력이 보상되는 구간이 된다.
