...
export const config = {
  ...
  debug: {
    ...
    //
    // ★★★ 2026-09-09: 검증용으로 다시 true — 임시다. ★★★
    //   이번 작업(사운드 기본값 조정 등) 확인이 끝나면 반드시 false로 되돌릴 것.
    //   프로덕션 빌드(dist/)에 이 값이 true인 채로 섞여 나가면 배포본에서 D키로
    //   구간점프·밸런스 슬라이더가 열린다 — 커밋하기 전에 여기부터 확인할 것.
    enabled: true,
  },
