...
export const config = {
  ...
  // === 튜토리얼 도우미 "러버"(ui/rover.js) ===
  // XP 검색 도우미(Search Companion) 패러디 — 좌측에서 슬라이드로 들어오는 사이드바.
  // 별도 튜토리얼 화면·스테이지가 아니다: 게임은 계속 돈다(일시정지 없음), 조건이
  // 맞을 때 화면 한쪽에서 잠깐 나타났다 사라질 뿐이다.
  //
  ...
  //   혼란이 생긴다.
  tutorial: {
    // 설정창의 [튜토리얼 힌트] 토글이 이 값을 실시간으로 바꾼다(기본 켜짐).
    enabled: true,
